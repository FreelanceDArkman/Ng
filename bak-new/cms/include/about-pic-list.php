...
"<form action=\"save_priority_about.php\" method=\"POST\" >".
...
"</tr>" ;
	...
	for($i =0;$i < count($data); $i++){
		...
		"<td style=\"text-align:center\"><img src=\"".$virtual_path."assets/img/slidemini/".$data[$i]->picname."\" style=\"width:200px\"/></td>" .
