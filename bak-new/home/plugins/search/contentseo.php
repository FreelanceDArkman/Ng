...
$mainframe->registerEvent( 'onSearch', 'plgSearchContentSeo' );
$mainframe->registerEvent( 'onSearchAreas', 'plgSearchContentAreasSeo' );
 ...
 */
function &plgSearchContentAreasSeo()
{
	static $areas = array(
		'content' => 'Articles'
	);
 ...
 */
function plgSearchContentSeo( $text, $phrase='', $ordering='', $areas=null )
{
	global $mainframe;
	...
	$title="Search ". $text." Result: ";
	$keywords=$text;
	$description="Search ". $text." Result: ". $text;
	...
	$seoLimit= $pluginParams->get( 'seo_limit', 		5 );
