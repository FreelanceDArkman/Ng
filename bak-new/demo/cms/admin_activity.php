                        ...
                        <div class="widget-content">
                            ...
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#slide-mini" data-toggle="tab">กิจกรรมทั้งหมด</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane  active" id="slide-mini">
                                        ...
                                        <form id="Upload" action="content_pro_ac_save.php" enctype="multipart/form-data" method="post">
                                            <input type="hidden" value="activity_content" name="sourcename" />
                                            <div class="widget">
                                                <div class="widget-header">
                                                    <i class="icon-list-alt"></i>
                                                    <h3>ใส่กิจกรรมใหม่</h3>
                                                </div>
                                                <div class="widget-content" id="holiday_insert_box">
                                                    <div class="row-fluid stats-box block-margin">
                                                        <div class="span2">
                                                            <div class="control-group">
                                                                <label class="control-label" for="holiday_title">เลือกไฟล์รูปภาพ <br/> <span>*ขนาด 579 x 129 px</span></label>
                                                                <div class="controls">
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="widget-content">
                                                <?php include 'include/activity_content_list.php';?>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("[data-customsave='1']").click(function () {
            ...
            var urls = "save_content_byId.php?id="+ cid + "&action=activity";
//serialize
