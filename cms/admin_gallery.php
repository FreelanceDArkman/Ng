...
<!--                                    <li class="active">-->
<!--                                        <a href="#slide-mini" data-toggle="tab">รูปบรรยากาศร้าน</a>-->
<!--                                    </li>-->
...
<!--                                <br>-->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane  active" id="slide-mini">
                                        ...
                                        <form id="Upload" action="upload_gallery.php" enctype="multipart/form-data" method="post">
                                            <div class="widget">
                                                <div class="widget-header">
                                                    ...
                                                    <div class="row-fluid stats-box block-margin">
                                                        <div class="span4">
                                                            <div class="control-group">
                                                                <label class="control-label" for="holiday_title">เลือกไฟล์รูปภาพ [ขนาดรูปภาพ 324 * 234 px]</label>
                                                                <div class="controls">
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="widget-content">
                                                <?php include 'include/gallery-pic-list.php';?>
                                            </div>
                                        </div>
                                    </div>
