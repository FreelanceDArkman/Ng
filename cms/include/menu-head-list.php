...
"<form action=\"save_head_menu.php\" method=\"POST\" >".
"<table class=\"table table-striped table-bordered\">" .
"<tbody>" .
"<tr>" .
"<th style=\"text-align:center\">หัวข้อเมนู</th>" .
...
"</tr>" ;
	...
	for($i =0;$i < count($data); $i++){
        ...
        "<input type=\"text\"  value=\"".$data[$i]->title."\" style=\"width:90%\" name=\"title_".$data[$i]->_id."\" /></td>".
		"<td style=\"text-align:center\">
