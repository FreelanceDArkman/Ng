...
ร้านอาหารนางนวล พัทยา อาหารทะเล" />
    <title>Welcome to the NangNaul Restaurant : Gallery</title>
...
<style type="text/css">
    ...
    .slider8 {
        width: 100%;
        height: 720px;
        background: transparent url(../img/slider8-bg1.jpg) no-repeat bottom center;
        position: relative;
        margin-bottom: 25px;
    }
</style>
...
<div id="mainContent" class="fullWidth">
    ...
    <h2 class="hdr4">บรรยากาศร้านของเรา</h2>

    <div class="slider8">

        <?php include 'include/gallerylist.php';?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var $s = $('#anythingSlider8'), nav = $('#externalNav a'), updateNav = function (page) {
