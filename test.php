...
<div class="ipad-box9">
    ...
    <div class="mCont">
        <form action="form/table.php" method="post" class="contactForm table">
            <fieldset>
                <label class="q1">
                    Year
                ...
                <label class="q1">
                    Month
                    <input name="month" required type="text">
                </label>
                <label class="q1">
                    Time
                ...
                <label class="q1">
                    Guests
                    <input name="guests" required type="text">
                </label>
                <label>
                    E-mail
...
<div id="header">
    <div class="container">
        ...
        <div class="logoContainer">
            <a href="1_home.html"><img src="assets/img/logo.png" alt=""></a>
        </div>
...
<div id="menuContainer">
    <div class="container">
        <ul class="mainMenu">
            ...
            <li class="subMenu">
                <a href="#">Menucard<span class="addTxt">Our real tasty food</span></a>
                <ul>
...
<div class="iphoneHeadline">
    <h1><span class="lft"></span>MENUCARD<span class="rt"></span></h1>
    <span class="ln2">Our real tasty food</span>
...
<div id="mainContent" class="sliderBack">
    <div class="container">
                        ...
                        <div class="slider-wrapper">
                            <div id="slider1Nivo" class="nivoSlider">
                                <div class="slider1Frame">
                                    <img src="assets/img/content/slider_small_01.jpg" alt="">
                                </div>
                                <div class="slider1Frame">
                                    <img src="assets/img/content/slider_small_02.jpg" alt="">
                                </div>
                                <div class="slider1Frame">
                                    <img src="assets/img/content/slider_small_03.jpg" alt="">
                                </div>
                                <div class="slider1Frame">
                                    <img src="assets/img/content/slider_small_04.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="column2 pull-right nobackg">
...
<div class="oneColumn">
    <div class="container">
        ...
        <h2 class="hdr4">Our Menucard Fullwidth</h2>

        <div class="slider5">
            <div id="externalNav">
                <a href="#1">Starters</a>
                <a href="#2">Main dish</a>
                <a href="#3">Dessert</a>
                <a href="#4">Drinks</a>
            </div>


            <ul id="anythingSlider5">
                <li>
                    <h3 class="hdr2"><span class="lft"></span>Starters<span class="rt"></span></h3>
                    <div class="slider5Set">
                        <div class="half1">


                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish7.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish8.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish9.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish10.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish11.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                        ...
                        <div class="half2">
                            ...
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish12.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish13.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish14.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish15.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                            ...
                            <hr class="divider3">
                            <div class="cn1">
                                <a href="img/content/dish17.jpg" data-rel="lightbox" ><img src="assets/img/content/dish16.jpg" alt=""></a>
                            </div>
                            <div class="cn2">
                                <span class="tx1">Seafood 1</span>
                                <span class="tx2">only 7.99 $</span>
                ...
                <li>
                    <h3 class="hdr2"><span class="lft"></span>Main dish<span class="rt"></span></h3>
                    <div class="slider5Set">
                        <div class="half1">
                ...
                <li>
                    <h3 class="hdr2"><span class="lft"></span>Dessert<span class="rt"></span></h3>
                    <div class="slider5Set">
                        <div class="half1">
                ...
                <li>
                    <h3 class="hdr2"><span class="lft"></span>Drinks<span class="rt"></span></h3>
                    <div class="slider5Set">
                        <div class="half1">
            ...
            <div class="pagesNr">
                <span class="nr1"></span><span class="nr2"></span>
            </div>
        </div>

        <div class="box5">
            <p><span class="highlight">FRESHEST SEAFOOD QUALITY</span> Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor
    ...
    <div class="container">
        ...
        <div class="mid">
            <div class="col1">
                ...
                <span class="hour">11:00 am - 09:00 pm</span>
                <span class="day">Tuesday</span>
                <span class="hour">11:00 am - 09:00 pm</span>
                <span class="day">Wendsday</span>
                <span class="hour">11:00 am - 09:00 pm</span>
            ...
            <div class="col2">
                ...
                <div class="brdr">
                    ...
                    <p>
                        123 Eastern 12th ST New York,
                        NY, North America<br><br>

                        +49 1234 56789-0
                        +49 1234 56789-12<br><br>

                        <a href="mailto:info@delimondo.com">info@delimondo.com</a>
                        <a href="#">www.delimondo.com</a>
                    </p>
            ...
            <div class="col3">
                <div class="lftMrg">
                    ...
                    <span class="data1">22 June, 2011  <img src="assets/img/data1-dot.png" alt="">  no comments</span>
                    <a href="#">Pellentesque habitant morbi tristique senectus et netus et male. </a>

                    <span class="data1">7 May, 2011  <img src="assets/img/data1-dot.png" alt="">  11 comments</span>
                    <a href="#">Pellentesque habitant morbi tristique senectus et netus et male. </a>
                </div>
            </div>
            <div class="clearfix"></div>
